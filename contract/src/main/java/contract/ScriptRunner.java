...
public class ScriptRunner
{
     ...
     * @param autoCommit  auto commit to database
     * @param stopOnError stop when error occur
     */
     ...
     * setDelimiter
     *
     * @param delimiter Delimitation of the string
     * @param fullLineDelimiter Delimitation of the line
     */
     ...
     *
     * @param userDirectory the user directory of the script to run
     */
     ...
     *
     * @param conn the connection to use for the script
     * @param command Exec of the sql command
     * @param lineReader Read line of the database
     * @throws IOException the I/O exception
     * @throws SQLException if any SQL errors occur
     */
